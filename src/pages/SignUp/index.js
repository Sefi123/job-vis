...
const SignUp = () => {
  ...
  return (
    <div class="px-5 py-20 relative flex flex-col items-center justify-center text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
      ...
      <form class="max-w-screen-lg mt-8 mb-2 max-w-80 sm:max-w-96">
        ...
        <Button className="w-full text-center text-[#164ED4] border border-[#164ED4] bg-white hover:bg-[#164ED4] hover:text-white">
          {" "}
          Sign Up
        </Button>
